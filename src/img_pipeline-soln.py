...
class imagePipeline():
    ...
    def __init__(self):
        ...
        self.img_pub = rospy.Publisher(
            '/processed_image', Image, queue_size=3, latch=True)
        ...
        self.img_sub = rospy.Subscriber(
            '/usb_cam/image_raw', Image, self.camera_callback)
    ...
    def set_process_type_handle(self, request):
        ...
        if request.data not in PROCESSING_OPTIONS:
            ...
            # TODO: Send an affirmative response.
            return {'success': True}
...
"""
PROCESSING_OPTIONS = {"raw", "flip", "color", "blur", "edge", "josh"}
